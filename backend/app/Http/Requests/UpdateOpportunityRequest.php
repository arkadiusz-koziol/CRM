...
final class UpdateOpportunityRequest extends FormRequest
{
    ...
    {
        return [
            'title.string' => 'The opportunity title must be a string.',
